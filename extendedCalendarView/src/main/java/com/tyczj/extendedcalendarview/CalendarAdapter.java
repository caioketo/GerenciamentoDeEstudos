...
public class CalendarAdapter extends BaseAdapter{
	...
	Calendar cal;
	public String[] days;
    private Day.EventLoaderListener loaderListener;
//	OnAddNewEventClick mAddEvent;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position >= 0 && position < 7){
            ...
            RelativeLayout rl2 = (RelativeLayout)v.findViewById(R.id.rl2);
    ...
    public void setEventLoaderListener(Day.EventLoaderListener listener){
        ...
        if(firstDay>1) {
	        for(j=0;j<(firstDay-FIRST_DAY_OF_WEEK)+7;j++) {
                ...
                if (loaderListener != null) {
                    d.setEventLoaderListener(loaderListener);
                }
	        	dayList.add(d);
	        }
        }
