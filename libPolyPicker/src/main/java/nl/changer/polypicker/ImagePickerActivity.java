...
public class ImagePickerActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static final String EXTRA_CAMERA_ONLY = "nl.changer.polypicker.extra.camera_only";
    public static final String EXTRA_PICTURE_ONLY = "nl.changer.polypicker.extra.picture_only";
    ...
    private boolean mPictureOnly = false;
    ...
    public void create() {
        ...
        mPictureOnly = getIntent().getBooleanExtra(EXTRA_PICTURE_ONLY, false);
        mCameraOnly = getIntent().getBooleanExtra(EXTRA_CAMERA_ONLY, false);
