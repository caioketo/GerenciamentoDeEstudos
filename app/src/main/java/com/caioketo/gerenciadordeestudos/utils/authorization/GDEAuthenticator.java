...
import static com.caioketo.gerenciadordeestudos.utils.authorization.AccountGeneral.*;

/**
 * Created by Caio on 03/11/2014.
 */
public class GDEAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "UdinicAuthenticator";
    private final Context mContext;

    public GDEAuthenticator(Context context) {
        super(context);
